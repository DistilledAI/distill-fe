...
const TableData: React.FC<{
  ...
  return (
    <Table
      ...
      classNames={{
        wrapper:
          "shadow-none bg-mercury-30 rounded-[22px] px-4 gap-0 overflow-x-auto",
        th: "bg-transparent h-5 p-0 pb-1 pr-4 text-base font-normal text-mercury-600 whitespace-nowrap",
        td: "pl-0 pr-4 py-2",
        thead:
        ...
        emptyWrapper: "h-10",
        base: twMerge("max-w-full", !!baseClassName && baseClassName),
      }}
