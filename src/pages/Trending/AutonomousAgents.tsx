...
const AutonomousAgents: React.FC = () => {
  return (
    <div className="flex w-full items-center gap-10">
      ...
      <div className="relative min-h-[280px] w-[45%]">
        <div
          style={{
            backgroundImage: `url(${spotlightBg})`,
          }}
          className="absolute top-1/2 h-[185px] min-w-[400px] -translate-y-1/2 rounded-[22px] bg-cover bg-center bg-no-repeat p-[18px]"
        >
