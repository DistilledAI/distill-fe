...
const Orchestration = () => {
  ...
  return (
    <div className="relative grid h-[calc(100dvh-50px)] grid-cols-1 overflow-hidden p-2 pb-0 max-sm:flex md:h-full md:max-h-[calc(100dvh-68px)] md:grid-cols-[2fr_1fr] md:gap-6 md:p-4 md:pl-10 md:pt-1">
