...
const Orchestration = () => {
  ...
  return (
    <div className="relative grid h-[calc(100dvh-50px)] grid-cols-1 overflow-hidden p-2 pb-0 max-sm:flex md:max-h-[calc(100dvh-68px)] md:grid-cols-[2fr_1.3fr] md:gap-4 md:p-4 md:pl-9 md:pt-1">
      <div>
