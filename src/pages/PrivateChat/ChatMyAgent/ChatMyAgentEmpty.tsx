  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center">
        ...
        {!isUserLogged ? (
          <Button
            className="mt-8 h-14 rounded-full bg-mercury-950 text-white max-md:h-[36px]"
            isLoading={loading}
          ...
          <Button
            className="mt-8 h-14 rounded-full bg-mercury-950 text-[16px] font-bold text-mercury-30"
            isLoading={loading}
