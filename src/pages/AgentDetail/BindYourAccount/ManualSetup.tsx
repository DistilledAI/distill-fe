import { XboxXFilled } from "@components/Icons"
...
const ManualSetup: React.FC<{ methods: any; refetch: any }> = ({
  methods,
  refetch,
}) => {
        ...
        <form className="w-full">
          <StepWrap
            label={
              <span>
                ...
                and App on
                <span className="text-green-500"> X Developer Portal</span>
              </span>
            }
                ...
                <ul className="list-disc pl-6 leading-6">
                  <li>
                    <span className="text-base-14-b">
                      App permissions:{" "}
                      <span className="text-[#F78500]">Read and write</span>
                    </span>
                  </li>
                  <li>
                    <span className="text-base-14-b">
                  ...
                  <li>
                    <span className="text-base-14-b">
                      ...
                      <span className="text-base-14 font-normal !text-mercury-900">
                        Fill in both the Callback URL/Redirect URL and Website
                        URL
                      </span>
                    </span>
                  </li>
          ...
          <StepWrap
            label={
              <span>
                Generate your App{" "}
                <span className="text-green-500">Access Token and Secret</span>
              </span>
            }
          >
            <InputField
