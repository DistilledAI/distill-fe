...
const Login = () => {
  ...
  return (
    <div
      className="relative mx-auto flex h-full min-h-[calc(100dvh-68px)] w-full flex-1 items-center justify-center rounded-[22px] border border-white bg-white bg-cover bg-center bg-no-repeat font-barlow max-md:h-[calc(100dvh-50px)]"
      style={{
