...
export const ShieldCheckFilledIcon: FunctionComponent<{
  color?: string
  size?: number
}> = ({ size = 24, color = "#A2845E" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
    ...
    >
      <path
        d="M11.9979 2.5L12.1159 2.507L12.1749 2.515L12.2359 2.528L12.3469 2.562C12.4235 2.59033 12.4964 2.62794 12.5639 2.674L12.6679 2.756L12.9229 2.974C14.9402 4.64956 17.4898 5.5493 20.1119 5.511L20.4539 5.501C20.6775 5.4908 20.898 5.55591 21.0802 5.6859C21.2625 5.81589 21.3958 6.00326 21.4589 6.218C21.9503 7.88958 22.1007 9.64288 21.9011 11.3737C21.7015 13.1046 21.156 14.7776 20.297 16.2935C19.4381 17.8093 18.2832 19.1371 16.901 20.1978C15.5187 21.2585 13.9374 22.0305 12.2509 22.468C12.0863 22.5107 11.9135 22.5107 11.7489 22.468C10.0623 22.0306 8.48087 21.2587 7.09853 20.198C5.71619 19.1374 4.56118 17.8096 3.70212 16.2938C2.84306 14.7779 2.29749 13.1048 2.09784 11.3739C1.89818 9.64301 2.04851 7.88964 2.53989 6.218C2.603 6.00326 2.73633 5.81589 2.91854 5.6859C3.10075 5.55591 3.3213 5.4908 3.54489 5.501C6.28236 5.62613 8.96796 4.72499 11.0759 2.974L11.3389 2.749L11.4349 2.674C11.5024 2.62794 11.5753 2.59033 11.6519 2.562L11.7639 2.528C11.8031 2.51861 11.8428 2.51159 11.8829 2.507L11.9979 2.5ZM15.7079 9.793C15.615 9.70002 15.5047 9.62626 15.3833 9.57594C15.2619 9.52562 15.1318 9.49971 15.0004 9.49971C14.869 9.49971 14.7389 9.52562 14.6175 9.57594C14.4961 9.62626 14.3858 9.70002 14.2929 9.793L10.9999 13.085L9.70689 11.793L9.61289 11.71C9.4119 11.5546 9.15929 11.4815 8.90637 11.5056C8.65344 11.5297 8.41918 11.6492 8.25114 11.8397C8.08311 12.0303 7.99391 12.2777 8.00167 12.5316C8.00942 12.7856 8.11355 13.027 8.29289 13.207L10.2929 15.207L10.3869 15.29C10.5793 15.4393 10.8195 15.5132 11.0626 15.4979C11.3056 15.4826 11.5347 15.3792 11.7069 15.207L15.7069 11.207L15.7899 11.113C15.9391 10.9206 16.0131 10.6803 15.9978 10.4373C15.9825 10.1943 15.8791 9.96519 15.7069 9.793H15.7079Z"
        fill={color}
      />
    </svg>
  )
...
export const CircleXFilledIcon: FunctionComponent<{
  color?: string
  size?: number
  ...
  return (
    ...
    >
      <path
        d="M11.332 2.22667C12.3375 2.80724 13.174 3.64035 13.7586 4.64353C14.3432 5.64672 14.6556 6.78518 14.665 7.94623C14.6744 9.10727 14.3803 10.2506 13.812 11.2631C13.2437 12.2756 12.4209 13.1221 11.4249 13.7189C10.4289 14.3156 9.29428 14.6419 8.13343 14.6654C6.97259 14.6889 5.82573 14.4088 4.8064 13.8528C3.78707 13.2969 2.93061 12.4844 2.32181 11.4957C1.71301 10.507 1.37297 9.37647 1.33536 8.216L1.33203 8L1.33536 7.784C1.3727 6.63266 1.70773 5.51064 2.30779 4.52733C2.90785 3.54402 3.75247 2.73297 4.75929 2.17325C5.76612 1.61354 6.9008 1.32426 8.0527 1.33362C9.20461 1.34299 10.3344 1.65066 11.332 2.22667ZM7.00603 6.09333C6.86635 6.01019 6.70111 5.98094 6.54137 6.01109C6.38164 6.04124 6.23842 6.12871 6.13866 6.25705C6.0389 6.3854 5.98947 6.54577 5.99967 6.708C6.00987 6.87024 6.07899 7.02316 6.19403 7.138L7.05536 8L6.19403 8.862L6.1387 8.92467C6.03509 9.05866 5.98637 9.22707 6.00243 9.39568C6.01849 9.5643 6.09814 9.72048 6.22518 9.8325C6.35222 9.94452 6.51714 10.004 6.68644 9.99882C6.85574 9.99365 7.01673 9.92423 7.1367 9.80467L7.9987 8.94333L8.8607 9.80467L8.92336 9.86C9.05736 9.96361 9.22577 10.0123 9.39438 9.99627C9.563 9.9802 9.71918 9.90056 9.8312 9.77352C9.94322 9.64647 10.0027 9.48155 9.99752 9.31226C9.99235 9.14296 9.92293 8.98197 9.80336 8.862L8.94203 8L9.80336 7.138L9.8587 7.07533C9.96231 6.94134 10.011 6.77293 9.99496 6.60432C9.9789 6.4357 9.89926 6.27952 9.77222 6.1675C9.64517 6.05548 9.48025 5.99601 9.31095 6.00118C9.14165 6.00635 8.98067 6.07577 8.8607 6.19533L7.9987 7.05667L7.1367 6.19533L7.07403 6.14L7.00603 6.09333Z"
        fill={color}
      />
    </svg>
  )
